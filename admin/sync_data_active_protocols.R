# 20230619: THIS RUNS FROM JSPSYCHHELPER. WHEN MOVING ALL ADMIN THINGS TO JSPSYCHADMIN, SHOULD RUN FROM JSPSYCHADMIN
...
jsPsychAdmin::CHECK_secrets_OK(path_to_credentials = "/home/emrys/gorkang@gmail.com/RESEARCH/PROYECTOS-Code/jsPsychR/jsPsychAdmin/")
